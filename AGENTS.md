...
`docs/PRD.md`, `docs/ARCHITECTURE.md`, `docs/adr/`. Roadmap: `docs/ROADMAP.md`. Setup y
checklist de smoke test: `docs/DEVELOPMENT.md`.
...
- Toda cadena visible en la UI pasa por i18n (`react-i18next`); ESLint bloquea literales JSX
  sueltos.
- El catálogo de eventos de dominio (`docs/ARCHITECTURE.md` §2, espejado en
